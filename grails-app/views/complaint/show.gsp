    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="complaintType" action="show"
                                                       id="${complaintInstance?.type?.id}">${complaintInstance?.type?.encodeAsHTML()}</g:link></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="customer" action="show"
                                                       id="${complaintInstance?.affects?.id}">${complaintInstance?.affects?.encodeAsHTML()}</g:link></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="utility" action="show"
                                                       id="${complaintInstance?.utility?.id}">${complaintInstance?.utility?.encodeAsHTML()}</g:link></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><g:link controller="message" action="show"
                                                       id="${complaintInstance?.source?.id}">${complaintInstance?.source?.encodeAsHTML()}</g:link></td>
